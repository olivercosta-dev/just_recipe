  ...
  return (
    <>
      <AddNewButtonContainer
        class="available-unit add-new-unit-btn"
        onClick={showDialog}
      >
        <AddNewImage src={addNewIcon} alt="Add New Icon" />
        <AddNewText class="unit-name">Add new</AddNewText>
      </AddNewButtonContainer>
      <Dialog ref={(el) => (dialogRef = el)}>
        <ModalContent>
          ...
          <form onSubmit={onSubmit}>
            ...
            />
            <FormLabel for="unit-image">Attach Image</FormLabel>
            <FormInput
              type="file"
              id="unit-image"
              name="unit-image"
